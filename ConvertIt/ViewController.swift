...
class ViewController: UIViewController {
    ...
    var formulasArray = [Formula(conversionString: "miles to kilometers", formula: {$0 / 0.62137}),
                        ...
                        Formula(conversionString: "quarts to liters", formula: {$0 * 1.056679}),
                        Formula(conversionString: "liters to quarts", formula: {$0 / 1.056679})]
